 ...
 * @see html.tpl.php
 */
function proper_omega_kickstart_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'proper_omega_kickstart');
 ...
 */
function proper_omega_kickstart_css_alter(&$css) {
 ...
 * Preprocess field.
 */
function proper_omega_kickstart_preprocess_field(&$variables) {
